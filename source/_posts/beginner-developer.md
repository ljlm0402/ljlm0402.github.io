...
2021년 IT 개발자에 대우와 복지가 상향하면서 많은 분들이 IT 업계로 전직 및 취업을 할려고 한다. 개발자 취업에 대해 Q&A 시간을 가져봅시다.

<!-- more -->

어느덧, 2022년이 벚꽃의 계절이 다가왔습니다. 코로나 사태에 따라 재택근무의 환경이 많아지면서 그에 따라 IT 업계에 많은 바람이 불어왔습니다.

많은 분들에 관심으로 다양한 직군에서도 IT 업계로 전직을 하시던가 IT를 처음 접하시는 분들에게 몇가지 조언을 해봅니다.

※ 오로지 주관적인 생각으로 글을 작성합니다.

### 본인 소개

우선, 글쓴이가 누구인지 궁금하시는 분들이 있으실겁니다. `누군데 이런 글을 작성하지 ?`라는 생각도 하실테니 우선 본인 소개부터 하겠습니다.

저는 IT 개발을 하고있는 3년차 개발자입니다. 또한 다양한 커뮤니티에서 활동을 하고 있습니다.

물론, 저라는 사람이 이런 기업에 다닌다고 년차가 있다고 해당 글을 작성해도 된다는 생각은 안합니다. 누구라도 저와 같은 생각을 하실수도 있으나

많은 커뮤니티 활동에서 다양한 분들이 질문으로 물어보는 사항에 대해서 답변식인 형태로 글을 작성합니다.

### 학력 (전공자 vs 비전공자)

> 비전공자인데 IT 업계에서 불편한 사항이 있는가 ?

대답으로는 `아니요`입니다. 처음 IT를 접하시는 분들의 가장 많이들 고민하시는 질문 사항입니다.
...
> 채용 지원을 할려는데, 기업에서 요구하는 언어랑 다른데... 언어가 그렇게 중요한가요 ?

대답은 `중요하지 않으면서 중요하다`, 이게 무슨 애매한 대답이냐고 생각하시는 분들이 있으실텐데
...
> 취준생인데요, 몇개월 공부 후에 대기업을 지원할지 아니면 중소나 스타트업에서 경력을 쌓고 대기업을 지원할지 고민입니다.
...
> 어떤 언어를 학습해야 하나 ?, 최신 트렌드를 학습해야하나 ?, 다양한 언어를 알아야 하나 ?

그 밖에 다양한 질문들이 있었습니다. 당연한 얘기겠지만 언어는 다양하게 알면 좋고, 최신 트렌드를 학습하면 좋습니다.

그러나 시간과 학습에 대한 노력은 한정되어 있습니다. 그래서 저는 딱 하나는 말씀드리고 싶습니다. 바로 `커뮤니티 활동`입니다.
